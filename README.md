...
* [x] the header h1 element exists. Include three asserts, if the header is in the document, if the header is truthy, if the header has the correct text content.
